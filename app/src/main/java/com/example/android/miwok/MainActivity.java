...
// Set a click listener on that View
        ...
        numbers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                Intent n1 = new Intent(MainActivity.this, Numbers.class);
                startActivity(n1);
            }
        });
...
//        startActivity(i);
//    }
//    public void open_familymember_activity(View v){
//        Intent i2=new Intent(this,Family_Members.class);
//        startActivity(i2);
//    }
//    public void open_color_activity(View v){
//        Intent i3=new Intent (this,Colors.class);
//        startActivity(i3);
//    }
//    public void open_phrase_activity(View v){
